...
adminRouter.post("/moderation/recipes/:recipeId/decision", validateBody(moderationDecisionSchema), async (req, res) => {
    ...
    await createNotificationAndDispatch(moderationNotificationTemplate({
